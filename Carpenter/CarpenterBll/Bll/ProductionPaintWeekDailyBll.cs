...
{
    public class ProductionPaintWeekDailyBll
    {
        private readonly Dao.ProductionPaintWeekDailyDao dal=null;

        public ProductionPaintWeekDailyBll ( )
        {
            dal = new Dao . ProductionPaintWeekDailyDao ( );
        }
