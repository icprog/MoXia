...
namespace Carpenter
{
    public partial class FormPlanAssembleDayDaily :FormChild
    {
        CarpenterEntity.PlanAssemebleDayDailyEntity _model=null;
        CarpenterBll.Bll.PlanAssembleDayDailyBll _bll=null;
        string strWhere="1=1"; DataTable tableView,printOne,printTwo;
        
        public FormPlanAssembleDayDaily ( )
        { 
            InitializeComponent ( );

            _model = new CarpenterEntity . PlanAssemebleDayDailyEntity ( );
            _bll = new CarpenterBll . Bll . PlanAssembleDayDailyBll ( );
            ...
            lupOddNum . Properties . DataSource = _bll . GetDataTableOnly ( "PLF001" );
            lupOddNum . Properties . DisplayMember = "PLF001";
            lupPn . Properties . DataSource = _bll . GetDataTableOnly ( "PLF002" );
            lupPn . Properties . DisplayMember = "PLF002";
            lupProN . Properties . DataSource = _bll . GetDataTableOnly ( "PLF003" );
            lupProN . Properties . DisplayMember = "PLF003";
        ...
        protected override int Query ( )
        {
            ...
            if ( !string . IsNullOrEmpty ( lupOddNum . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PLF001='" + lupOddNum . Text + "'";
            if ( !string . IsNullOrEmpty ( lupPn . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PLF002='" + lupPn . Text + "'";
            if ( !string . IsNullOrEmpty ( lupProN . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PLF003='" + lupProN . Text + "'";
            if ( !string . IsNullOrEmpty ( dtpDaily . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PLF012='" + dtpDaily . Text + "'";
        ...
        protected override int Print ( )
        {
            ...
            Print ( new DataTable [ ] { printOne ,printTwo } ,"组装日计划报工打印.frx" );
        ...
        protected override int Export ( )
        {
            ...
            Export ( new DataTable [ ] { printOne ,printTwo } ,"组装日计划报工打印.frx" );
        ...
        bool printOrExport ( )
        {
            FormDWPrint from = new FormDWPrint ( "组装" );
