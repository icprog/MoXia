...
namespace Carpenter
{
    public partial class FormProductionPaintDayDaily :FormChild
    {
        CarpenterEntity.ProductionPaintDayDailyEntity _model=null;
        CarpenterBll.Bll.ProductionPaintDayDailyBll _bll=null;
        string strWhere="1=1"; DataTable tableQuery,printOne,printTwo;
        
        public FormProductionPaintDayDaily ( )
        {
            InitializeComponent ( );
            
            _model = new CarpenterEntity . ProductionPaintDayDailyEntity ( );
            _bll = new CarpenterBll . Bll . ProductionPaintDayDailyBll ( );
            ...
            lupOddNum . Properties . DataSource = _bll . GetDataTableOnly ( "PWF001" );
            lupOddNum . Properties . DisplayMember = "PWF001";
            lupPn . Properties . DataSource = _bll . GetDataTableOnly ( "PWF002" );
            lupPn . Properties . DisplayMember = "PWF002";
            lupProN . Properties . DataSource = _bll . GetDataTableOnly ( "PWF003" );
            lupProN . Properties . DisplayMember = "PWF003";
        }
        ...
        protected override int Query ( )
        {
            ...
            if ( !string . IsNullOrEmpty ( lupOddNum . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PWF001='" + lupOddNum . Text + "'";
            if ( !string . IsNullOrEmpty ( lupPn . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PWF002='" + lupPn . Text + "'";
            if ( !string . IsNullOrEmpty ( lupProN . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PWF003='" + lupProN . Text + "'";
            if ( !string . IsNullOrEmpty ( dtpDaily . Text . Trim ( ) ) )
                strWhere = strWhere + " AND PWF012='" + dtpDaily . Text + "'";
        ...
        protected override int Print ( )
        {
            ...
            Print ( new DataTable [ ] { printOne ,printTwo } ,"油漆日计划报工打印.frx" );
        ...
        protected override int Export ( )
        {
            ...
            Export ( new DataTable [ ] { printOne ,printTwo } ,"油漆日计划报工打印.frx" );
        ...
        bool printOrExport ( )
        {
            FormDWPrint from = new FormDWPrint ( "油漆" );
