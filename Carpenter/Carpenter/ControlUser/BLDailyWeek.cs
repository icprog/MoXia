...
namespace Carpenter . ControlUser
{
    ...
    public partial class BLDailyWeek :UserControl
    {
        DataTable tableQuery;
        public BLDailyWeek ( DataTable tableQuery )
        {
            InitializeComponent ( );
        ...
        public DataTable getTable
        {
            get
            {
                ...
                {
                    row . BeginEdit ( );
                    row [ "PDK012" ] = Convert . ToDateTime ( dateTimePicker1 . Value . ToString ( "yyyy-MM-dd HH:mm:ss" ) );
                    row . EndEdit ( );
                }
